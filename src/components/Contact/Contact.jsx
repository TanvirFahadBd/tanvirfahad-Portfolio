...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_gelu3mj', 'template_u7jdioa', formRef.current, {
                publicKey: '_Ao-vf1mVDs3-MFcU',
            })
            .then(
                () => {
                    setSuccess(true);
        ...
        <motion.div className="Contact" variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textConteiner" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Gmail</h2>
                    <span>tanvir01749176442@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Address</h2>
                    <span>Palashbari,Asulia,Savar,Dhaka</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Phone Number</h2>
                    <span>01954144426</span>
                </motion.div>
            </motion.div>
            <motion.div className="formConteiner" variants={variants}>
                ...
                <motion.form
                    ...
                    {error && <span style={{ color: "red", marginTop: "10px" }} className="error">There was an error sending the message. Please check your console.</span>}
                    {success && <span style={{ color: "green", marginTop: "10px" }} className="success">Message sent successfully.</span>}
                </motion.form>
            </motion.div>
